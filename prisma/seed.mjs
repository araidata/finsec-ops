...
async function main() {
  ...
  const oneTrustMaintenanceRenewal = await prisma.maintenanceRenewal.create({
    data: {
      ...
      coOpAgreement: "DIR Cooperative Contract",
      coOpContractNumber: "DIR-CPO-5237",
      coOpAgreementExpirationDate: date("2028-08-31"),
  ...
  await prisma.maintenanceRenewal.create({
    data: {
      ...
      coOpAgreement: "BuyBoard Technology Contract",
      coOpContractNumber: "BUYBOARD-TECH-2027",
      coOpAgreementExpirationDate: date("2028-12-31"),
